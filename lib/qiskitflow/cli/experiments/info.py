...
def _get_runs(name: str, metrics: str, parameters: str, order_by: str, order_type: str):
    """ Get run list.
...
def experiment_info(name: str, metrics: str, parameters: str, order_by: str, order_type: str):
    ...
    runs = _get_runs(name, metrics, parameters, order_by, order_type)
